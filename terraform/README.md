...
|------|-------------|------|---------|:--------:|
| <a name="input_deployment_options"></a> [deployment\_options](#input\_deployment\_options) | Deployment Options for Orthac app configuration | `map(string)` | <pre>{<br/>  "ConfigRepo": "https://github.com/digihunchinc/orthanc-config.git",<br/>  "InitCommand": "pwd && echo Custom Init Command Here",<br/>  "SiteName": null<br/>}</pre> | no |
